...
from supervised_learning import supervised_ui
...
# === Optimizer Playground ===
    ...
    with st.expander("🧠 Taylor Series & Optimizer Foundations", expanded=True):
        ...
        # try:
        #     func_choice = st.selectbox("Choose a function to expand:", ["cos(x)", "exp(x)", "ln(1+x)", "tanh(x)", "Custom"])
        ...
        #     custom_expr = None
            ...
            #     elif choice == "Custom":
            #         user_input = st.text_input("Enter your function f(x):", "x**2 * sin(x)")
            #         try:
